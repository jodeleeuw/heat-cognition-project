var jsPsychTimelineSpatialNback = (function (exports) {
  ...
  function createInstructions(instruction_pages_data = instruction_pages, texts = trial_text) {
    ...
    return {
      ...
      button_label_previous: (_a = texts == null ? void 0 : texts.back_button) != null ? _a : trial_text.back_button,
      button_label_next: (_b = texts == null ? void 0 : texts.next_button) != null ? _b : trial_text.next_button,
      data: {
        task: "spatial-nback",
        phase: "instructions"
      }
  ...
  function createTimeline({
    ...
    var _a, _b;
    const effective_prompt = (_a = prompt != null ? prompt : texts == null ? void 0 : texts.prompt) != null ? _a : trial_text.prompt;
    const effective_buttons = (_b = buttons != null ? buttons : texts == null ? void 0 : texts.button) != null ? _b : trial_text.button;
    const sequence = generateNBackSequence(total_trials, n_back, target_percentage, rows, cols);
    const trials = [];
    for (let i = 0; i < total_trials; i++) {
      const trial_instructions = `<p>${effective_prompt.replace(/{n_back}/g, n_back.toString()).replace(/{plural}/g, n_back > 1 ? "s" : "").replace(/{trial}/g, (i + 1).toString()).replace(/{total}/g, total_trials.toString())}</p>`;
      trials.push({
        ...
        on_load: function() {
          var _a2;
          (_a2 = document.getElementById("nback-grid-container")) == null ? void 0 : _a2.classList.add("timeline-trial");
